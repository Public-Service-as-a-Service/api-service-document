...
VALUES
    ...
    ('d0000001-0000-0000-0000-000000000001', 1, '2025-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0001', false, null, false, 'Pure draft document', 'c0000000-0000-4000-8000-000000000001', '2998', null, null, 'DRAFT'),
    -- ACTIVE doc (published, currently valid)
    ('d0000001-0000-0000-0000-000000000002', 1, '2025-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0002', false, null, false, 'Active published doc', 'c0000000-0000-4000-8000-000000000001', '2998', '2025-01-01', '2027-12-31', 'ACTIVE'),
    -- SCHEDULED doc (published with future validFrom)
    ('d0000001-0000-0000-0000-000000000003', 1, '2025-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0003', false, null, false, 'Scheduled doc', 'c0000000-0000-4000-8000-000000000001', '2998', '2027-01-01', '2028-12-31', 'SCHEDULED'),
    -- EXPIRED doc (validTo passed)
    ('d0000001-0000-0000-0000-000000000004', 1, '2024-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0004', false, null, false, 'Expired doc', 'c0000000-0000-4000-8000-000000000001', '2998', '2024-01-01', '2024-12-31', 'EXPIRED'),
    -- REVOKED doc
    ('d0000001-0000-0000-0000-000000000005', 1, '2025-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0005', false, null, false, 'Revoked doc', 'c0000000-0000-4000-8000-000000000001', '2998', '2025-01-01', '2027-12-31', 'REVOKED'),
    -- Pre-read reconcile case: ACTIVE but validTo passed -> reads should flip to EXPIRED
    ('d0000001-0000-0000-0000-000000000006', 1, '2024-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0006', false, null, false, 'Stale active doc that should expire on read', 'c0000000-0000-4000-8000-000000000001', '2998', '2024-01-01', '2024-06-30', 'ACTIVE'),
    -- Pre-read reconcile case: SCHEDULED with validFrom in past -> reads should flip to ACTIVE
    ('d0000001-0000-0000-0000-000000000007', 1, '2024-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0007', false, null, false, 'Stale scheduled doc that should activate on read', 'c0000000-0000-4000-8000-000000000001', '2998', '2024-01-01', '2027-12-31', 'SCHEDULED'),
    -- onlyLatestRevision regression case: rev1=ACTIVE + rev2=DRAFT for same regNum
    ('d0000001-0000-0000-0000-000000000010', 1, '2025-01-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0008', false, null, false, 'Multi-rev: rev 1 active', 'c0000000-0000-4000-8000-000000000001', '2998', '2025-01-01', '2027-12-31', 'ACTIVE'),
    ('d0000001-0000-0000-0000-000000000011', 2, '2025-02-01 00:00:00.000', 'a0000000-0000-0000-0000-0000000000bb', '2025-2998-0008', false, null, false, 'Multi-rev: rev 2 draft', 'c0000000-0000-4000-8000-000000000001', '2998', '2025-01-01', '2027-12-31', 'DRAFT');